var size = 0;
var placement = 'point';
function categories_Monitoring_11(feature, value, size, resolution, labelText,
...
var style_Monitoring_11 = function(feature, resolution){
    ...
    var repeat = 0;
    var placement = 'point';
    if (feature.get("Notes") !== null && resolution > 0 && resolution < 7) {
        labelText = String(feature.get("Notes"));
    }
    
    var style = categories_Monitoring_11(feature, value, size, resolution, labelText,
